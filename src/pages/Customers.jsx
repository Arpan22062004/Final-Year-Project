...
export default function Customers() {
    ...
    return (<div className="space-y-6">
      ...
      <Card>
        ...
        {filtered.length === 0 && (<div className="py-12 text-center text-sm text-slate-400">{customers.length ? 'No customers found. Try adjusting your search.' : 'No customers yet. Add your first customer to start building relationships.'}</div>)}
      </Card>
