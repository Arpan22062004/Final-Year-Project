{/* <a href="https://optiora-pi.vercel.app/" target="_blank" rel="noreferrer" > Visit Live App </a> */}
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center">
      <div className="text-center text-white">
        <h1 className="text-4xl font-bold">Optiora</h1>
        ...
        <a
          href="https://optiora-pi.vercel.app/"
          target="_blank"
          rel="noreferrer"
